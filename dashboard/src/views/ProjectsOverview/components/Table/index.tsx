...
export default function ProjectsOverviewTable() {
    ...
    const [projectsList, setProjectsList] = useState<getProjectsResponse>(mockedProjectsResponse);
                ...
                >
                    <thead>
                        <tr>
                            ...
                            <th style={{ width: 100, padding: '0.7rem 0.5rem' }}>Number of versions</th>
                            <th style={{ width: 340, padding: '0.7rem 0.5rem' }}>Created At</th>
                            <th style={{ width: 140, padding: '0.7rem 4.5rem', textAlign: 'end' }}>Delete</th>
                        </tr>
                    </thead>
