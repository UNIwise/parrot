...
// CreateLanguagesVersion mocks base method.
func (m *MockService) CreateLanguagesVersion(ctx context.Context, projectID int, name string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateLanguagesVersion", ctx, projectID, name)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateLanguagesVersion indicates an expected call of CreateLanguagesVersion.
func (mr *MockServiceMockRecorder) CreateLanguagesVersion(ctx, projectID, name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateLanguagesVersion", reflect.TypeOf((*MockService)(nil).CreateLanguagesVersion), ctx, projectID, name)
}
